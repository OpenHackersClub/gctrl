...
Local daemon + vault is always the source of truth during development. Cloud deploy mirrors the pattern in [gctrl-board/vault/WORKFLOW.md — Deployment](../../gctrl-board/vault/WORKFLOW.md#deployment) with the additional R2 vault mount.
