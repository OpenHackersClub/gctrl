/**
 * Deployment smoke tests for gctrl-board Cloudflare Worker.
 *
 * Run against a deployed Worker URL:
 *   DEPLOY_URL=https://gctrl-board.debuggingfuturecors.workers.dev pnpm vitest run tests/deploy-smoke.test.ts
 *
 * Tests verify:
...
const BASE_URL = process.env.DEPLOY_URL ?? "https://gctrl-board.debuggingfuturecors.workers.dev"
...
describeDeployment("Deployment Smoke Tests", () => {
  ...
  describe("Static Assets", () => {
    it("serves index.html at root", async () => {
      ...
      expect(body).toContain("gctrl board")
