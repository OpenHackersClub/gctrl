...
| 5 | `apps/utils/skills/` | shipped | Repo-shipped skills (e.g. `/dispatch`, `/review`). Lives under the `utils` app vault to reflect that skills are a subclass of utility; the leaf stays `skills` for agentskills host discovery. |
...
### 11.1 A gctrl-shipped skill — `apps/utils/skills/dispatch/SKILL.md`
