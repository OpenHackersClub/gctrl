...
> **Source of truth:** [`specs/formal/KernelSpec/IssueState.lean`](../../formal/KernelSpec/IssueState.lean)
> States, transitions, forward-only ordering, terminal convergence, and universal cancel are machine-checked (11 theorems, zero `sorry`).
...
> Acyclicity via topological ordering, edge addition/removal preservation, subgraph monotonicity are machine-checked (14 theorems).
