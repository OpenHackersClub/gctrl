...
How work flows through gctl — from ideation to merged PR. This is gctl's own workflow.

> **Workflow specs**: Opinionated product workflows (issue lifecycle, product cycle, PR review, PRD template) live in `apps/gctl-board/specs/workflows/`. Kernel-level orchestration and dispatch are defined in `specs/architecture/kernel/`.
...
Follows [issue-lifecycle.md](../../apps/gctl-board/specs/workflows/issue-lifecycle.md).
...
Follows [pr-review.md](../../apps/gctl-board/specs/workflows/pr-review.md).
