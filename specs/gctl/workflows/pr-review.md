# Template: PR Review Conventions

Defines PR structure, review checklist, agent-authored PR rules, and merge strategy. Applications adopt this template for consistent PR workflows.
